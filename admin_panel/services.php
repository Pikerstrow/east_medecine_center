               ...
               <div class="col-xs-12 col-sm-12 col-lg-4">
                  ...
                  if($request->has('edit_service')){
                     ...
                     <form action="" method="post" class="category-form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                           ...
                           <div class="input-group" style="width:100%">
                              ...
                              <input type="text" name="price" id="price"
                                     class="form-control input-admin input-category"
                                     required="required" placeholder="Введіть ціну" value="<?php echo (isset($data['price']) ? $data['price'] : '') ?>">
                           </div>
                        ...
                        <div class="form-group">
                           <button type="submit" class="form-control admin-sumb-button" name="add_service">Додати</button>
                        </div>
                        <hr>
                     </form>
                     <?php
                           ...
                           <div class="form-group">
                              ...
                              <div class="input-group">
                                 ...
                                 <div class="input-group-btn">
                                    <button type="submit" name="filter_apply" class="btn btn-success btn-sm text-center">
                        ...
                        <?php if (count($services) > 0): ?>
                           <?php foreach ($services as $service): ?>
                              <tr>
                                 ...
                                 <td style="width:50px;"><?php echo $service->getCategory($service->service_category_id) ?></td>
                                 <td style="width:90px;"><img width="90" src="<?php echo $service->service_image ?>"></td>
