...
$imagesNewsBodyURL =  $siteURL . "/admin_panel/images/publications_body/";
...
if(isset($_FILES['image'])){
   ...
   $targetPath = $rootForImage . "admin_panel" . DIRECTORY_SEPARATOR . "images" . DIRECTORY_SEPARATOR . "publications_body" . DIRECTORY_SEPARATOR;
