...
$imagesNewsBodyURL =  $siteURL . "/admin_panel/images/categories_body/";
...
if(isset($_FILES['image'])){
   ...
   $targetPath = $rootForImage . "admin_panel" . DIRECTORY_SEPARATOR . "images" . DIRECTORY_SEPARATOR . "categories_body" . DIRECTORY_SEPARATOR;
